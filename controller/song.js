...
//   console.log(
//     "\x1b[33m%s\x1b[0m",
//     `Gotta optimize so that there aren't multiple requests to the database`
//   );
...
//     songPath = path.join(cwd(), song.filePath);
//     contentTypeHeader = "audio/flac";
//   } else {
//     songPath = path.join(cwd(), song.filePathLossy);
...
// export { getSongMetadata, search, stream };
